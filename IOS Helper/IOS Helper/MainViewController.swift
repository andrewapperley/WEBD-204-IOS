...
class MainViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
  ...
  let data: [Section] = [
    Section(title: "UI", elements: [
      ...
      Element(title: "UISwitch", viewController: UIHelp_UIView(with: "Stuff")),
      Element(title: "UILabel", viewController: UIHelp_UIView(with: "Stuff")),
      ...
      Element(title: "UITextView", viewController: UIHelp_UIView(with: "Stuff")),
      Element(title: "UITextField", viewController: UIHelp_UIView(with: "Stuff")),
      Element(title: "UICollectionView", viewController: UIHelp_UIView(with: "Stuff")),
      ...
      Element(title: "UIAnimations", viewController: UIHelp_UIView(with: "Stuff")),
      Element(title: "UIKitDynamics", viewController: UIHelp_UIView(with: "Stuff")),
    ])
  ]
